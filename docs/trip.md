...
ブラウザでトリップを検索するには[トリップ検索サイト](https://olivier-zinro.fc2.net/blog-category-21.html)や[UTF](https://milkybot.wiki.fc2.com/wiki/UncoTripFinder)などのサイトがあります。

また、PC向けにMeriken's Tripcode Engineという高速なトリップ検索ソフトがあります。パソコンを持っている人はこちらを使うのがいいかと思います。
...
## 追記
いくら探しても12桁トリップ検索サイトを見つけられなかったので、[12桁トリップ作成機](https://tripcodefinder.pages.dev/tripcodefinder/)を作りました。
